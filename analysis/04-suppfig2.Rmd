...
```{r depends-paths}
filt_path <- here::here("data/processed/02-sc_seurat.rds")
```
...
knitr::kable(data.frame(
     File = c(
         getDownloadLink2("suppfigure2-panelA.png", str_sub(here::here("output", DOCNAME),2,-1)), # bug one "/" plus
         getDownloadLink2("suppfigure2-panelA.pdf", str_sub(here::here("output", DOCNAME),2,-1))
     ),
     Description = c(
         "Supplementary Figure 2 panel A (PNG)",
         "Supplementary Figure 2 panel A (PDF)"
     )
 ))
```
