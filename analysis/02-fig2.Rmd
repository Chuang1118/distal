...
if (file.exists(filt_path)) {
    UMI_df = read.csv(paste0(filt_path,"filtered_endogenes_UMI.csv"), stringsAsFactors = FALSE, header = TRUE, sep=",",check.names=FALSE)
    metadata_df = read.csv(paste0(filt_path,"filtered_metadata_allFeatures.csv"), stringsAsFactors = FALSE, header = TRUE, sep=",",check.names=FALSE)
  } else {
...
```{r save}
saveRDS(sc_seurat, here::here("data/processed/02-sc_seurat.rds"))
saveRDS(subset, here::here("data/processed/02-sc_seurat_subset.rds"))
save(metadata_df, file = here::here("data/processed/02-sc_seurat_metadata.RData"))
```
...
readr::write_lines(params, here::here("output", DOCNAME, "figure2-parameters.json"))

knitr::kable(data.frame(
     File = c(
         getDownloadLink2("figure2-parameters.json", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelA.png", str_sub(here::here("output", DOCNAME),2,-1)), # bug one "/" plus
         getDownloadLink2("figure2-panelA.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelB.png", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelB.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelC.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelC.png", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelF.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelF.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelG.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelG.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelH.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure2-panelH.pdf", str_sub(here::here("output", DOCNAME),2,-1))
     ),
     Description = c(
         "Parameters set and used in this analysis",
         "Figure 2 panel A (PNG)",
         "Figure 2 panel A (PDF)",
         "Figure 2 panel B (PNG)",
         "Figure 2 panel B (PDF)",
         "Figure 2 panel C (PNG)",
         "Figure 2 panel C (PDF)",
         "Figure 2 panel F (PNG)",
         "Figure 2 panel F (PDF)",
         "Figure 2 panel G (PNG)",
         "Figure 2 panel G (PDF)",
         "Figure 2 panel H (PNG)",
         "Figure 2 panel H (PDF)"
     )
 ))
```
