...
```{r depends-paths}
filt_path <- here::here("data/processed/patient.integrated.rds")
```
...
```{r loading-table}
# DEA by Anno_1
dea_f = read.csv(file = here::here("data/processed/DEA_byAnno_1.csv"), header = TRUE)
...
```{r save}
saveRDS(patient.integrated, here::here("data/processed/03-sc_seurat.rds"))
save(metadata_df, file = here::here("data/processed/03-sc_seurat_metadata.RData"))
```
...
knitr::kable(data.frame(
     File = c(
         getDownloadLink2("figure4-panelC.png", str_sub(here::here("output", DOCNAME),2,-1)), # bug one "/" plus
         getDownloadLink2("figure4-panelC.pdf", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure4-panelD.png", str_sub(here::here("output", DOCNAME),2,-1)),
         getDownloadLink2("figure4-panelD.pdf", str_sub(here::here("output", DOCNAME),2,-1))
     ),
     Description = c(
         "Figure 4 panel C (PNG)",
         "Figure 4 panel C (PDF)",
         "Figure 4 panel D (PNG)",
         "Figure 4 panel D (PDF)"
     )
 ))
```
